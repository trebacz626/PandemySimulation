...
public class ComplexMap extends MapCreator{
    public MapBuilder getMapBuilder(){
        return new MapBuilder(53, 27)
                ...
                .addPavementX(4, 6, 8)
                .addRetailShop(4, 7, "Lidl", "German 6")
                ...
                .addPavementX(4, 6, 21)
                .addRetailShop(4, 20, "Stokrotka", "Flower Street 3")
                ...
                .addRetailShop(13, 6, "Paprika Shop", "Vegetable Street 4")
                ...
                .addRetailShop(19, 6, "Goodbye", "Goodbye Street 15")
                ...
                .addRetailShop(25, 6, "Hello Shop", "Hello Street 7")
                ...
                //last Shop
                .addRetailShop(35, 13, "Nameless Shop", "Middle of Nowhere")
                ...
                .addWholesaleShop(35, 23, "Makro", "Best 7")
                ...
                .addWholesaleShop(35, 4, "Some Shop", "Sinamone 4")
        
                .addRoadX(47,51,24)
                .addRoadY(24,8,52)
                .addRoadX(52, 48, 7)
                .addWholesaleShop(52, 14, "Last One Standing", "New York Avenue")
