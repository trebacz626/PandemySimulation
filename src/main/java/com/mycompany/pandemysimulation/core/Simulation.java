...
public class Simulation {
    ...
    private void createScene(){
        MapBuilder mapBuilder = new MapBuilder(53, 27)
                ...
                .addRetailShop(15, 19, "nie wiem", "eloooo")
                ...
                .addRetailShop(27, 19, "nie wiem", "eloooo")
        ...
        boolean [][][] pDirections = mapBuilder.getPedestrianDirections();
